...
// slacrawl emits via `slacrawl export adapter`. It is a self-contained copy of
// the shared contract (the same struct shape stationtrail, sourceharvest, and
// discrawl carry) so MiseLedger can ingest slacrawl output without a shared
// dependency.
package adapter
